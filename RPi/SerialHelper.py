...
class ComPort(QThread):
    ...
    # Sanity check -- The string from the COM port should be of length 7 or 8
    ...
    def readDataStream(self):
        ...
        while(True):
            ...
            # String should have 7 or 8 characters
            ...
            if(len(line) == 7 or len(line) == 8):
                ...
                try:
                    ...
                    sensorID = int(lineStr[2:4])
                    c = lineStr[4:6]  # Get 4th and 5th char (temp data)
